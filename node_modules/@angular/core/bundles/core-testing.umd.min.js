...
/**
     ...
     * found in the LICENSE file at https://angular.io/license
     */
var C=function(){function e(){var e=this;this._promise=new Promise(function(t,r){e._resolve=t,e._reject=r})}return e.prototype.done=function(e){this._resolve(e)},e.prototype.fail=function(e,t){this._reject(e)},Object.defineProperty(e.prototype,"promise",{get:function(){return this._promise},enumerable:!0,configurable:!0}),e}(),w=function(){function e(){}return e.prototype.insertRootElement=function(e){},e}(),D=new t.InjectionToken("ComponentFixtureAutoDetect"),P=new t.InjectionToken("ComponentFixtureNoNgZone"),N=new Map;
/**
     * @license
     * Copyright Google Inc. All Rights Reserved.
     *
...
/**
     ...
     * found in the LICENSE file at https://angular.io/license
     */
function S(e){var t=[],r=new Map;function n(t){var n=r.get(t);if(!n){var o=e(t);r.set(t,n=o.then(I))}return n}return R.forEach(function(e,r){var o=[];e.templateUrl&&o.push(n(e.templateUrl).then(function(t){e.template=t}));var i=e.styleUrls,s=e.styles||(e.styles=[]),u=e.styles.length;i&&i.forEach(function(t,r){s.push(""),o.push(n(t).then(function(n){s[u+r]=n,i.splice(i.indexOf(t),1),0==i.length&&(e.styleUrls=void 0)}))});var c=Promise.all(o).then(function(){return function e(t){F.delete(t)}
/**
     * @license
     * Copyright Google Inc. All Rights Reserved.
     *
     * Use of this source code is governed by an MIT-style license that can be
     * found in the LICENSE file at https://angular.io/license
     */(r)});t.push(c)}),A(),Promise.all(t).then(function(){})}var R=new Map,F=new Set;function j(e){return F.has(e)}function A(){var e=R;return R=new Map,e}function I(e){return"string"==typeof e?e:e.text()}var k=0,x=function(){function e(){this._references=new Map}return e.prototype.overrideMetadata=function(e,r,n){var o={};if(r&&function i(e){var t=[];Object.keys(e).forEach(function(e){e.startsWith("_")||t.push(e)});for(var r=e;r=Object.getPrototypeOf(r);)Object.keys(r).forEach(function(e){var n=Object.getOwnPropertyDescriptor(r,e);!e.startsWith("_")&&n&&"get"in n&&t.push(e)});return t}
/**
     * @license
     * Copyright Google Inc. All Rights Reserved.
     *
...
/**
     ...
     * Use of this source code is governed by an MIT-style license that can be
     * found in the LICENSE file at https://angular.io/license
     */function ie(){return ee=ee||new oe}
/**
     * @license
     * Copyright Google Inc. All Rights Reserved.
     *
...
/**
     ...
     * found in the LICENSE file at https://angular.io/license
     */
e.ɵangular_packages_core_testing_testing_b=oe,e.ɵangular_packages_core_testing_testing_c=ie,e.ɵangular_packages_core_testing_testing_a=de,e.TestBed=he,e.getTestBed=fe,e.inject=me,e.InjectSetupWrapper=ye,e.withModule=function _e(e,t){return t?function(){var r=fe();return e&&r.configureTestingModule(e),t.apply(this)}:new ye(function(){return e})}
/**
     * @license
     * Copyright Google Inc. All Rights Reserved.
     *
     * Use of this source code is governed by an MIT-style license that can be
     * found in the LICENSE file at https://angular.io/license
     */,e.ɵMetadataOverrider=x,e.async=function Me(e){var t="undefined"!=typeof Zone?Zone:null;if(!t)return function(){return Promise.reject("Zone is needed for the async() test helper but could not be found. Please make sure that your environment includes zone.js/dist/zone.js")};var r=t&&t[t.__symbol__("asyncTest")];return"function"==typeof r?r(e):function i(e){return n.jasmine?function(t){t||((t=function(){}).fail=function(e){throw e}),o(e,this,t,function(e){if("string"==typeof e)return t.fail(new Error(e));t.fail(e)})}:function(){var t=this;return new Promise(function(r,n){o(e,t,r,n)})}}(e)},e.ComponentFixture=i,e.resetFakeAsyncZone=m,e.fakeAsync=function Te(e){return v?v.fakeAsync(e):function t(e){return function(){for(var t=[],r=0;r<arguments.length;r++)t[r]=arguments[r];var n=c.assertPresent();if(p)throw new Error("fakeAsync() calls can not be nested");p=!0;try{if(!l){if(n.getDelegate()instanceof u)throw new Error("fakeAsync() calls can not be nested");l=new u}var o=void 0,i=n.getDelegate();n.setDelegate(l);try{o=e.apply(this,t),h()}finally{n.setDelegate(i)}if(l.pendingPeriodicTimers.length>0)throw new Error(l.pendingPeriodicTimers.length+" periodic timer(s) still in the queue.");if(l.pendingTimers.length>0)throw new Error(l.pendingTimers.length+" timer(s) still in the queue.");return o}finally{p=!1,a()}}}(e)},e.tick=function Oe(e){return void 0===e&&(e=0),v?v.tick(e):function t(e){void 0===e&&(e=0),d().tick(e)}(e)},e.flush=function be(e){return v?v.flush(e):function t(e){return d().flush(e)}(e)},e.discardPeriodicTasks=function Ee(){if(v)return v.discardPeriodicTasks();!function e(){d().pendingPeriodicTimers.length=0}()},e.flushMicrotasks=function Ce(){return v?v.flushMicrotasks():h()},e.TestComponentRenderer=w,e.ComponentFixtureAutoDetect=D,e.ComponentFixtureNoNgZone=P,e.__core_private_testing_placeholder__="",e.ɵTestingCompiler=ce,e.ɵTestingCompilerFactory=le,Object.defineProperty(e,"__esModule",{value:!0})});